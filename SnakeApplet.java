...
public class SnakeApplet extends Applet implements Observer {
	...
	// This is a hack to allow the loading of multi-media from within the Applet security model.
	private static String staticAppletCodebase = "/";
	public static String getStaticAppletCodebase() {
		return staticAppletCodebase;
	}
		
	public static void main(String args[]) {	
		/*if (args.length > 0) {	
			new SnakeApplet(args[0]);
		} else {
			new SnakeApplet(DEFAULT_GAME_FILE);	
		}*/
	}
	
	
  public void init() { 
	initGame(DEFAULT_GAME_FILE);
  }
  ...
  {	
	...
	public void initGame(String gameFile) {
